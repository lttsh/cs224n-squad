...
cl upload experiments/$EXPERIMENT/best_checkpoint -n checkpoint1
cl upload experiments/$EXPERIMENT/best_checkpoint -n checkpoint2
...
python code/main.py --json_in_path=data.json --experiment_name=ensemble --mode=ensemble_predict'
